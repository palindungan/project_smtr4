					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="number" class="form-control" id="jml_porsi" placeholder="Jumlah Porsi" name="jml_porsi" required="" oninvalid="this.setCustomValidity('isi Jumlah Porsi Makanan')" oninput="setCustomValidity('')">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="tot_biaya">Total Biaya</label>
								<input type="number" class="form-control" id="tot_biaya" placeholder="Total Biaya" name="tot_biaya" required="" oninvalid="this.setCustomValidity('isi Total Biaya')" oninput="setCustomValidity('')">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="tot_dp">Total Dp</label>
								<input type="number" class="form-control" id="tot_dp" placeholder="Total Dp" name="tot_dp" required="" oninvalid="this.setCustomValidity('isi Total Dp')" oninput="setCustomValidity('')">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="sisa_bayar">Sisa Bayar</label>
								<input type="number" class="form-control" id="sisa_bayar" placeholder="Sisa Bayar" name="sisa_bayar" required="" oninvalid="this.setCustomValidity('isi Sisa Bayar')" oninput="setCustomValidity('')">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="ket_acara" placeholder="Lokasi Acara" name="ket_acara" required="" oninvalid="this.setCustomValidity('isi Lokasi Acara')" oninput="setCustomValidity('')">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="tgl_acara">Tanggal Acara</label>
								<input type="date" class="form-control" id="tgl_acara" placeholder="Tanggal Acara" name="tgl_acara" required="" oninvalid="this.setCustomValidity('isi Total Dp')" oninput="setCustomValidity('')">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="tgl_pelunasan">Tanggal Pelunasan</label>
								<input type="date" class="form-control" id="tgl_pelunasan" placeholder="Tanggal Pelunasan" name="tgl_pelunasan" required="" oninvalid="this.setCustomValidity('isi Tanggal Pelunasan')" oninput="setCustomValidity('')">
							</div>
						</div>
					</div>
