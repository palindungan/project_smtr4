    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('admin/menu/data_kategori/tambah_aksi'); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="id_kat">Kode Kategori</label>
                            <input type="text" class="form-control" id="id_kat" readonly="" name="id_kat" value="<?php echo $kode; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
