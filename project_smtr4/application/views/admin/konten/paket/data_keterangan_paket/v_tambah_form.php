    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('admin/paket/data_keterangan_paket/tambah_aksi'); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="id_keterangan_paket">Kode Ketentuan</label>
                            <input type="text" class="form-control" id="id_keterangan_paket" readonly="" name="id_keterangan_paket" value="<?php echo $kode; ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
