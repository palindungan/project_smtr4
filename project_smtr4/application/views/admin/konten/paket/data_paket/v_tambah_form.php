    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('admin/paket/data_paket/tambah_aksi'); ?>

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="id_paket">Kode Paket</label>
                            <input type="text" class="form-control" id="id_paket" readonly="" name="id_paket" value="<?php echo $kode; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="hrg_paket" placeholder="Harga" name="hrg_paket">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="jml_menu">Jumlah Menu</label>
                            <input type="number" class="form-control" id="jml_menu" placeholder="Jumlah Menu" name="jml_menu">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
