        ...
        $(".tombol_edit").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var admin = "";
                    var kasir = "";
                    if (obj['tbl_user'][0]['level'] == "owner") {
                        owner = "selected";
                    }
                    if (obj['tbl_user'][0]['level'] == "admin") {
                        admin = "selected";
                    }
                    if (obj['tbl_user'][0]['level'] == "kasir") {
                        kasir = "selected";
                    }

                    var pria = "";
                    var wanita = "";
                    if (obj['tbl_user'][0]['jenkel_user'] == "pria") {
                        pria = "selected";
                    }
                    if (obj['tbl_user'][0]['jenkel_user'] == "wanita") {
                        wanita = "selected";
                    }
                    ...
                    $('.isi_modal_edit').html(`
                        ...
                        <div class="form-group row">
                            <label for="exampleInput1" class="col-sm-3 col-form-label">Kode User</label>
                            <div class="col-sm-9">
                                <input name="id_user" type="text" class="form-control form_data1" id="exampleInput1" readonly="" value="` + obj['tbl_user'][0]['id_user'] + `">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInput2" class="col-sm-3 col-form-label">Nama</label>
                            <div class="col-sm-9">
                                <input name="nm_user" type="text" class="form-control form_data1" id="exampleInput2" placeholder="Nama" value="` + obj['tbl_user'][0]['nm_user'] + `">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInput3" class="col-sm-3 col-form-label">Alamat</label>
                            <div class="col-sm-9">
                                <textarea name="almt_user" class="form-control form_data1" id="almt_user1" rows="3" placeholder="Alamat">` + obj['tbl_user'][0]['almt_user'] + `</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInput4" class="col-sm-3 col-form-label">Jenis Kelamin</label>
                        ...
                        <div class="form-group row">
                            <label for="exampleInput5" class="col-sm-3 col-form-label">Username</label>
                            <div class="col-sm-9">
                                <input name="username" type="text" class="form-control form_data1" id="exampleInput5" placeholder="Username" value="` + obj['tbl_user'][0]['username'] + `">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInput6" class="col-sm-3 col-form-label">Password</label>
