<!-- js untuk ajax -->
<script src="<?= base_url(); ?>assets/template/back/js/jquery.js"></script>

<!-- Bootstrap core JavaScript-->
<script src="<?= base_url(); ?>assets/template/back/vendor/jquery/jquery.min.js"></script>
<script src="<?= base_url(); ?>assets/template/back/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Core plugin JavaScript-->
<script src="<?= base_url(); ?>assets/template/back/vendor/jquery-easing/jquery.easing.min.js"></script>
