                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Data User / Tambah User</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo base_url() . 'admin/data_user/tambah_aksi'; ?>" method="post">
                                        <div class="row">
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group">
                                                    <label>Kode User</label>
                                                    <input readonly="" type="text" class="form-control" id="kode_user" name="kode_user" placeholder="Kode User" required="" oninvalid="this.setCustomValidity('isi Kode User')" oninput="setCustomValidity('')" value="<?php echo $kode; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mb-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_user" name="nama_user" placeholder="Nama User" required="" oninvalid="this.setCustomValidity('isi Nama User')" oninput="setCustomValidity('')">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo base_url() . 'admin/data_user/tambah_data'; ?>"> <input type="Button" value="Batal"></a>
                                                </div>
                                                <!-- tombol submit disini -->
