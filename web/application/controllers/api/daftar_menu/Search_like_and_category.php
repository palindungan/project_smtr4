...
class Search_like_and_category extends REST_Controller
{
    ...
    function index_get()
    {
        ...
        if ($nm_menu != "") {
            ...
            $cek = $this->M_data_menu->get_by_nama_dan_kat($nm_menu, $nm_kat)->num_rows();

            // cek apakah ada data dari username
            if ($cek > 0) {

                // mengambil data dari database berdasarkan username
                $query = $this->M_data_menu->get_by_nama_dan_kat($nm_menu, $nm_kat);
